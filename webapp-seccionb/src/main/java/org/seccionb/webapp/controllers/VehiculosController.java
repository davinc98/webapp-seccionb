...
public class VehiculosController implements Serializable {
    ...
    public void init() {
        ...
        cajonesEstacionamiento = cajonEstacionamientoService.listar();
        tiposTarjeton = vehiculoService.tiposTarjeton();
        estatusVehiculo = vehiculoService.estatusVehiculo();
    ...
    public String guardar() {
        System.out.println("PERSONA ID:" + personaId);
        System.out.println("PERSONA: " + personaVehiculo);
        System.out.println("VEHICULO GUARDAR: "+vehiculo);
        ...
        this.vehiculos = vehiculoService.listar();
        return "gestionEstacionamiento.jsf?idPersona=" + personaId + "&faces-redirect=true";
    }
    ...
    public String eliminarVehiculo() {
        ...
        return "gestionVehiculos.jsf?idPersona=" + personaId + "&faces-redirect=true";
    }
